...
| <a name="input_public_access_cidrs"></a> [public\_access\_cidrs](#input\_public\_access\_cidrs) | List of CIDRs for public access, use this variable to restrict access to the EKS control plane. | `list(string)` | `[]` | no |
